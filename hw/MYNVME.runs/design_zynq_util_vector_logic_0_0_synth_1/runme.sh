...
HD_PWD='C:/Users/hpdh0/Desktop/NVME_0323/MYNVME.runs/design_zynq_util_vector_logic_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_zynq_util_vector_logic_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_zynq_util_vector_logic_0_0.tcl
